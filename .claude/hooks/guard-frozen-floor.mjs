// PreToolUse: block Edit/Write/MultiEdit that OVERWRITE an existing frozen floor artifact
// or the live ensemble_vote seam. Creating a new file is allowed (Task 0/14 write these).
...
process.stdin.on("end", () => {
  try {
    ...
    const FROZEN = /(\/fixtures\/floor_prices\.csv|\/PREREG\.md|\/UNIVERSE_RULE\.md|\/advisor\/portfolio\/allocator\.py)$/;
